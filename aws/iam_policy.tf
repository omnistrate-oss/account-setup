  ...
  policy = <<POLICY
{
  "Statement": [
    ...
    },
    {
      ...
      "Effect": "Allow",
      "Resource": [
        "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/omnistrate-*",
        "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/ows-ec2-node-group-role",
